...
ggsave(plot=.Last.value, filename="experiences_of_top_n_fav_trails.png", dpi=150, width=12, height=8)
```
...
ggsave(plot=.Last.value, filename="experiences_of_top_n_frequented_trails.png", dpi=150, height=8, width=12)
